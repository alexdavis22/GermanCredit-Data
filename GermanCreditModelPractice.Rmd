...
ntrees=5000, max_depth=6, learn_rate=0.1, sample_rate=0.6, col_sample_rate=0.7)
...
**NOTE: I'm not sure how to make the h2o code reproducible. Despite setting a seed my code returns a slightly different output every time. I'm seeing AUC ranges of anywhere from 0.80-0.84 in the knitted html document. Conventional accuracy is ranging from about 0.80-0.85. I'm also seeing that every time the model runs it is minimizing false positives while still correctly predicting Good credit risks the majority of the time, which is exactly what a business stakeholder would want in this scenario.** 
